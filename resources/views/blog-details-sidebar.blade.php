                                            ...
                                            <div class="viewall-one">
                                                <ul>
                                                    <li><a href="{{ url('categories') }}">Digital Marketing
                                                            <span>01</span></a></li>
                                                    <li><a href="{{ url('categories') }}">Future trends <span>10</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="view-all">
                            ...
                            <div class="card-body">
                                <ul class="latest-posts">
                                    <li>
                                        ...
                                        <div class="post-info">
                                            <h6>
                                                <a href="{{ url('blog-details') }}">Understanding Service Marketplace Fees:
                                                    A Guide...</a>
                                            </h6>
                                            <div class="blog-user">
                                    ...
                                    <li>
                                        ...
                                        <div class="post-info">
                                            ...
                                            <div class="blog-user">
                                                <img src="{{ URL::asset('/assets/img/user/user-13.jpg') }}" alt="user">
                                                <div class="blog-user-info">
                                                    <p>Anne Castaneda</p>
                                    ...
                                    <li>
                                        ...
                                        <div class="post-info">
                                            ...
                                            <div class="blog-user">
                                                <img src="{{ URL::asset('/assets/img/user/user-16.jpg') }}" alt="user">
                                                <div class="blog-user-info">
                                                    <p>Dann Bowman</p>
                ...
                <div class="col-lg-8">
                    <div class="blog-details">
                        <div class="blog-detail-img">
                            <img src="{{ URL::asset('/assets/img/blog/blog-03.jpg') }}" class="img-fluid" alt="img">
                        </div>
                            ...
                            <ul class="review-lists">
                                ...
                                <li>
                                    <div class="review-wrap">
                                        <div class="review-user-info">
                                            <div class="review-img">
                                                <img src="{{ URL::asset('/assets/img/user/user-11.jpg') }}"
                                                    alt="img">
                                            </div>
                                            <div class="reviewer-info">
                                                <div class="reviewer-loc">
