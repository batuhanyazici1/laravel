                ...
                <div class="row">
                        ...
                        <div class="blog-grid">
                            ...
                            <div class="blog-content">
                                <div class="user-head">
                                    <div class="user-info">
                                        <a href="javascript:void(0);"><img
                                                src="{{ URL::asset('/assets/img/user/user-10.jpg') }}" alt="img"></a>
                        ...
                        <div class="blog-grid">
                            ...
                            <div class="blog-content">
                                <div class="user-head">
                                    <div class="user-info">
                                        <a href="javascript:void(0);"><img
                                                src="{{ URL::asset('/assets/img/user/user-11.jpg') }}" alt="img"></a>
                                        <h6><a href="javascript:void(0);">David Shorey</a><span>Jan 23, 2024</span></h6>
                                    </div>
                                    <div class="badge-text">
                                        <a href="javascript:void(0);" class="badge bg-primary-light">User Guide</a>
                                    </div>
                                </div>
                                <div class="blog-title">
                                    <h3><a href="{{ url('blog-details') }}">Understanding Service Marketplace Fees: A Guide
                                            for New Users</a></h3>
                                </div>
                                <div class="blog-content-footer d-flex justify-content-between align-items-center">
                                    <p><span><i class="feather-clock"></i></span>10 - 15 mins read</p>
                                ...
                                <div class="user-head">
                                    <div class="user-info">
                                        <a href="{{ url('blog-details') }}"><img
                                                ...
                                                alt="img"></a>
                                        <h6><a href="javascript:void(0);">Kent Choi</a><span>Jan 25, 2024</span></h6>
                                    </div>
                                    <div class="badge-text">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-grid">
                            <div class="blog-img">
                                <a href="{{ url('blog-details') }}"><img
                                        src="{{ URL::asset('/assets/img/blog/blog-06.jpg') }}" class="img-fluid"
                                        alt="img"></a>
                                <div class="fav-selection">
                                    <a href="javascript:void(0);" class="fav-icon"><i class="feather-heart"></i></a>
                                </div>
                            ...
                            <div class="blog-content">
                                <div class="user-head">
                                    <div class="user-info">
                                        <a href="javascript:void(0);"><img
                                                ...
                                                alt="img"></a>
                                        <h6><a href="javascript:void(0);">Anne Castaneda</a><span>Jan 27, 2024</span></h6>
                                    </div>
                                    <div class="badge-text">
                                ...
                                <div class="blog-title">
                                    <h3><a href="{{ url('blog-details') }}">The Importance of a Portfolio and How to
                                            Create One That Stands Out</a></h3>
                                </div>
                                <div class="blog-content-footer d-flex justify-content-between align-items-center">
                                    <p><span><i class="feather-clock"></i></span>10 - 15 mins read</p>
                                </div>
                                ...
                                <div class="user-head">
                                    <div class="user-info">
                                        <a href="javascript:void(0);"><img
                                                ...
                                                alt="img"></a>
                                        <h6><a href="javascript:void(0);">Kylee Zamudio</a><span>Jan 29, 2024</span></h6>
                                    </div>
                                    <div class="badge-text">
                                        <a href="javascript:void(0);" class="badge bg-primary-light">Digital Marketing</a>
                                    </div>
                                </div>
                                <div class="blog-title">
                                    <h3><a href="{{ url('blog-details') }}">Leveraging Digital Marketing Services for
                                ...
                                <div class="user-head">
                                    <div class="user-info">
                                        <a href="javascript:void(0);"><img
                                                ...
                                                alt="img"></a>
                                        <h6><a href="javascript:void(0);">Dann Bowman</a><span>Jan 30, 2024</span></h6>
                                    </div>
                                    <div class="badge-text">
                                        <a href="javascript:void(0);" class="badge bg-primary-light">Graphic Design</a>
                                    </div>
                                </div>
                                <div class="blog-title">
                                    <h3><a href="{{ url('blog-details') }}">Graphic Design for Social Media: Tips to
                                            Engage Your Audience</a></h3>
                                </div>
                                <div class="blog-content-footer d-flex justify-content-between align-items-center">
                                    <p><span><i class="feather-clock"></i></span>05 - 10 mins read</p>
                                </div>
