                                ...
                                <div class="trend-items owl-carousel">
                                    <div class="trend-box">
                                        <div class="trend-info">
                                            <h6><a href="{{ url('service-sub-category') }}">Website Promotion</a></h6>
                                            <p>(80 Services)</p>
                                        </div>
                                        <a href="{{ url('service-sub-category') }}"><i
                                                class="feather-arrow-up-right"></i></a>
                                    </div>
                                    <div class="trend-box">
                                        <div class="trend-info">
                                            <h6><a href="{{ url('service-sub-category') }}">Ecommerce-Seo</a></h6>
                                            <p>(42 Services)</p>
                                        </div>
                                        <a href="{{ url('service-sub-category') }}"><i
                                                class="feather-arrow-up-right"></i></a>
                                    ...
                                    <div class="trend-box">
                                        <div class="trend-info">
                                            <h6><a href="{{ url('service-sub-category') }}">Promoted Listing</a></h6>
                                            <p>(24 Services)</p>
                                        </div>
                                        <a href="{{ url('service-sub-category') }}"><i
                                                class="feather-arrow-up-right"></i></a>
                                    ...
                                    <div class="trend-box">
                                        <div class="trend-info">
                                            <h6><a href="{{ url('service-sub-category') }}">Social Ecommerce</a></h6>
                                            <p>(55 Services)</p>
                                        </div>
                                        <a href="{{ url('service-sub-category') }}"><i
                                                class="feather-arrow-up-right"></i></a>
